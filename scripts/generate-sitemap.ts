...
const entries: SitemapEntry[] = [
  ...
  { path: "/escolher-plano", changefreq: "monthly", priority: "0.7" },
  { path: "/verificar-email", changefreq: "monthly", priority: "0.5" },
  { path: "/checkout/sucesso", changefreq: "monthly", priority: "0.5" },
];
